...
{
public:
    PinExt(int pin, bool alternativeAddr = false) : Pin(pin), Tca6408a(alternativeAddr) {};
...
public:
    PinInputExt(int pin, bool alternativeAddr = false) : pin(pin), Tca6408a(alternativeAddr) {};
